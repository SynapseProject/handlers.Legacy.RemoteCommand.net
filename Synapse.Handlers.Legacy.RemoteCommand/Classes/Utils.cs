...
namespace Synapse.Handlers.Legacy.RemoteCommand
{
	public static class Utils
	{
        ...
        public static string FormatNamedPowershellParameters(XmlElement parameters, String prefix, String joinedBy, bool useQuotes=true, bool skipBlankValues=false, XmlNode overrideParameters=null)
        {
            return FormatNamedParameters(parameters, prefix, joinedBy, useQuotes, skipBlankValues, overrideParameters, true);
        }
        
        public static string FormatNamedParameters(XmlElement parameters, String prefix, String joinedBy, bool useQuotes=true, bool skipBlankValues=false, XmlNode overrideParameters=null, Boolean isPowershell=false)
        {
